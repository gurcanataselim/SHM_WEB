...
public class haritadaGoster extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//tbody/tr[40]/td[1]/div[1]/button[1]/span[1]/span[1]")
    public WebElement haritadaGoster;



    @Test
    public void testharitadaGoster() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(haritadaGoster));
        haritadaGoster.click();
        Thread.sleep(2000);
