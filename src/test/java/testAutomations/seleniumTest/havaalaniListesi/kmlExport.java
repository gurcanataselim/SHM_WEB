...
public class kmlExport extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//tbody/tr[63]/td[1]/div[1]/button[3]/span[1]/span[1]")
    public WebElement kmlExport;
    ...
    public void testkmlExport() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(kmlExport));
        kmlExport.click();
        Thread.sleep(20000);
