...
public class GölgelemeCalısmasıSilme extends testAutomations.TestBase {
    ...
    @Test
    public void testGölgelemeCalısmasıSilme() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(SilmeButonu));
        SilmeButonu.click();
