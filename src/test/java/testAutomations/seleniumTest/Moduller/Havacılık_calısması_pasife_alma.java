...
public class Havacılık_calısması_pasife_alma extends testAutomations.TestBase {
    ...
    public WebElement DosyaPasifButonu;
    ...
    @Test
    public void testHavacılık_calısması_pasife_alma() throws Exception {
        ...
        Fwait.until(ExpectedConditions.visibilityOf(DosyaPasifButonu));
        DosyaPasifButonu.click();
