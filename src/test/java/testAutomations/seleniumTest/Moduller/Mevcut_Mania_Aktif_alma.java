...
public class Mevcut_Mania_Aktif_alma extends testAutomations.TestBase {
    ...
    @FindBy(xpath = "//tbody/tr[2]/td[1]/div[1]/button[2]")
    public WebElement AktifeAlma;
    ...
    @Test
    public void testMevcut_Mania_Aktif_alma() throws Exception {
...
//        PasifDurumSecimi.click();
        ...
        Fwait.until(ExpectedConditions.visibilityOf(AktifeAlma));
        AktifeAlma.click();
