package testAutomations.seleniumTest.CografiKuzeyAcisi;
...
public class CografiKuzeyAcisi extends testAutomations.TestBase{
    ...
    @Test
    public void testCografiKuzeyAcisi() throws Exception {
