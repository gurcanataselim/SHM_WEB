...
// test2222 için haritada gör butonu kullanılmıştır.
    @FindBy(xpath = "//tbody/tr[9]/td[1]/div[1]/button[1]/span[1]")
    ...
    public void testharitadaGor() throws Exception {
        ...
        try{
            ...
            Logger.warn("İlk eklenen kayıt test2222 haritada gösterilemedi.");
        }
